            ...
            <div style="display:flex; justify-content:center;">
                <div style="flex-basis: 30%;">
                    ...
                    <map name="Italia">
                        ...
                        <area shape="poly" coords="173,171,160,314,255,298,297,210" onclick="Regione(4)" alt="Submit request" >
                        <area shape="poly" coords="466,366,478,569,546,498,512,427" onclick="Regione(5)" alt="Submit request" >
